...
/*
0xFC1CCdcA6b4670516504409341A31e444FF6f43F: create 2 contracts:

1.
0x882448f83d90B2bf477Af2eA79327fDEA1335D93: v_token

2.
0xe8Ff5C9c75dEb346acAc493C463C8950Be03Dfba: v_coin
...
contract VIBEXToken is StandardToken {
    ...
    uint public constant ETH_RECEIVED_CAP = 115 * (10**3) * 10**decimals; // 115 000 ETH
    uint public constant ETH_RECEIVED_MIN = 0;//1 * 10**decimals; // 0 ETH
    uint public constant TOKEN_MIN = 1 * 10**decimals; // 1 VIBEX
    uint public constant MIN_ETH_TRANS = 25 * 10**decimals; // 25 ETH

    // We need to keep track of how much ether have been contributed, since we have a cap for ETH too
    uint public totalReceivedEth = 0;
