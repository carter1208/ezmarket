...
uint constant TOKEN_LIMIT = 150 * 1**6 * 1**18;
...
uint public constant TOKENS_FOR_SALE = 103548812 * 1**18;
...
atl.mint(_teamFund, 22500000 * 1**18);
atl.mint(_bountyFund, 18750000 * 1**18);
atl.unfreeze();
