...
// ================= Crowsale contracts  =======================
contract EZMarket is SafeMath, StandardToken, Pausable {
...
contract EZMCrowdsale is Ownable, SafeMath, Pausable {
    ...
    uint256 public maxSale      = 114000000;
    uint256 public decimals     = 8;
    address public depositAddress;
    address public tokenAddress;

    //START: Saturday, October 14, 2017 10:00:00 AM    1507975200000
    //END:   Saturday, November 25, 2017 10:00:00 AM   1511604000000
    uint256 public presaleTime  = 1506859200;
    uint256 public startTime    = 1506859200;
    ...
    uint[6] public prices = [1300, 1250, 1200, 1150, 1100, 1000];
    ...
    function EZMCrowdsale(address _depositAddress, address _tokenAddress) {
        ...
        etoken = EZMarket(tokenAddress);
        isFinalized = false;

        //test
        presaleTime = now;
        startTime = presaleTime + 30 minutes;
        endTime = startTime + 20 minutes;
        phases = [
        startTime + 5 minutes,
        startTime + 10 minutes,
        startTime + 15 minutes,
        startTime + 20 minutes,
        startTime + 25 minutes,
        endTime
        ];
    }
