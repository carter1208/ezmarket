...
contract AToken is ERC20Token {

    // ------------------------------------------------------------------------
    // Token information
    // ------------------------------------------------------------------------
    string public constant symbol = "AAA";
    string public constant name = "AAAToken";
    ...
    function AToken() {
        ...
        ENDDATE   = now + 4 weeks;
        CAP       = 100;
        multisig  = 0xeB7d37772F3AdE3DcA88D67cAcc0C53eEb23dCd6;
    }
    ...
    function () payable {
        ...
        // Log events
        TokensBought(msg.sender, msg.value, totalEthers, tokens,
    ...
    uint256 newTotalSupply, uint256 price);
